...
def TokenChecker():
    ...
    file_token_discord_relative = "C:\Programming\Python\LensorTool\TokenDisc.txt"
    file_token_discord = os.path.join("C:\Programming\Python\LensorTool\TokenDisc.txt")
